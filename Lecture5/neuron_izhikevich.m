...
flagS = 5; % select 1 of 20 spike train patterns 
N = 5000; % number of grid points
tMax = 100; % max time [ms]

% Step 3: Define model parameters [a b c d I] for all 20 patterns

coeffM = zeros(20,5); % pre-allocate 
...
coeffM(8,:) = [0.02 -0.1 -55 6 0]; % Class II
...
tm = [   ' 1: Tonic Spiking                '; ...
 ...
 Iext(N/10: end) = I; % define size of I
